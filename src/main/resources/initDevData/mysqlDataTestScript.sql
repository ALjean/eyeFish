...
INSERT INTO `baits_seasons_properties` (`id`, `bait_id`, `start_period`, `end_period`) VALUES
...
INSERT INTO `ecosystem_properties` (`id`, `parameter_id`, `min_value`, `max_value`, `deep_id`) VALUES
	(1, 6, 0.5, 1.2, 'SHALLOW'),
	(2, 6, 1.3, 1.9, 'MIDDLE'),
	(3, 6, 2, 2.5, 'DEEPLY'),
