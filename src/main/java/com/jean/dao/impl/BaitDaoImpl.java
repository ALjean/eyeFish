...
public class BaitDaoImpl extends BaseDaoImpl implements BaitDao {
	...
	public List<Bait> getOptimalBaits(Integer fishId, String baitType, String baitName, PondEnvirmoment pondEnv) throws DaoDfmException{
	...
	private List<Bait> getBaitsByPondParams(PondEnvirmoment pondEnv, List<String> names, int baitId) throws DaoDfmException {
		...
		if (names.size() > 0) {
			for (String paramName : names) {
				sql.append(" AND q.param_name = '" + paramName + "' AND (" + chooseValue(paramName, pondEnv)
	...
	private Float chooseValue(String paramName, PondEnvirmoment pondEnv) throws DaoDfmException {
	...
	@Override
	public List<Bait> getBaitsByPondParams(String baitType, String baitName, Integer fishId, PondEnvirmoment pondEnv,
